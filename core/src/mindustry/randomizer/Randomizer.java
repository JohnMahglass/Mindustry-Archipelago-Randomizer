...
public class Randomizer {
    ...
    private void initializeSerpuloItems() {
        addItem(Shared.MINDUSTRY_BASE_ID + 0, Blocks.conveyor);
        addItem(Shared.MINDUSTRY_BASE_ID + 1, Blocks.junction);
        addItem(Shared.MINDUSTRY_BASE_ID + 2, Blocks.router);
        addItem(Shared.MINDUSTRY_BASE_ID + 3, Blocks.launchPad);
        addItem(Shared.MINDUSTRY_BASE_ID + 4, Blocks.distributor);
        addItem(Shared.MINDUSTRY_BASE_ID + 5, Blocks.sorter);
        addItem(Shared.MINDUSTRY_BASE_ID + 6, Blocks.invertedSorter);
        addItem(Shared.MINDUSTRY_BASE_ID + 7, Blocks.overflowGate);
        addItem(Shared.MINDUSTRY_BASE_ID + 8, Blocks.underflowGate);
        addItem(Shared.MINDUSTRY_BASE_ID + 9, Blocks.container);
        addItem(Shared.MINDUSTRY_BASE_ID + 10, Blocks.unloader);
        addItem(Shared.MINDUSTRY_BASE_ID + 11, Blocks.vault);
        addItem(Shared.MINDUSTRY_BASE_ID + 12, Blocks.itemBridge);
        addItem(Shared.MINDUSTRY_BASE_ID + 13, Blocks.titaniumConveyor);
        addItem(Shared.MINDUSTRY_BASE_ID + 14, Blocks.phaseConveyor);
        addItem(Shared.MINDUSTRY_BASE_ID + 15, Blocks.massDriver);
        addItem(Shared.MINDUSTRY_BASE_ID + 16, Blocks.payloadConveyor);
        addItem(Shared.MINDUSTRY_BASE_ID + 17, Blocks.payloadRouter);
        addItem(Shared.MINDUSTRY_BASE_ID + 18, Blocks.armoredConveyor);
        addItem(Shared.MINDUSTRY_BASE_ID + 19, Blocks.plastaniumConveyor);
        addItem(Shared.MINDUSTRY_BASE_ID + 20, Blocks.coreFoundation);
        addItem(Shared.MINDUSTRY_BASE_ID + 21, Blocks.coreNucleus);
